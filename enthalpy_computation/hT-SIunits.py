...
ylabel = st.sidebar.text_input("Y-axis Label", "Enthalpy (J/kg)")
...
ax.tick_params(axis='both', which='major', labelsize=tick_label_size, width=tick_thickness)
ax.tick_params(axis='both', which='minor', width=tick_thickness * 0.7)
